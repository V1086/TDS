...
--- Before Day-5 ---
I already knew the basics of Git, including repositories, commits, pushing changes, and general version control workflows.
--- 
...
- Gained a more in-depth understanding of Git workflows and version control concepts.
- Improved my understanding of staging, committing, pushing, and repository management.
- Learned how Git tracks changes and how to inspect project history more effectively.
- Became more comfortable using SSH authentication and working with remote repositories.
- Learned about Git tags, which were completely new to me before this session.
- Practiced creating and managing annotated tags for versioning and releases.
- Reinforced best practices for commit messages and repository organization.
---

--- Feedback (Suggestions for the TDS Team) ---
This is my feedback:

The session was easy to follow and understand. The explanations were clear, and the practical examples helped make the Git concepts easier to grasp and apply.
---
